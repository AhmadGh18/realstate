...
<div class="formbold-main-wrapper">
    ...
    <div class="formbold-form-wrapper">
        <form action="handleupdateInfo.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="formbold-input-flex">
                ...
                <div>
                    <input type="text" name="phone" required id="phone" value="<?php echo $user["phone"] ?>"
                        placeholder="(319) 555-0115" class="formbold-form-input" />
