			...
			<div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
				<div class="d-flex flex-column align-content-end">
					<div class="app-auth-body mx-auto">
						...
						<h2 class="auth-heading text-center mb-5">Log in to Your Account</h2>
						<div class="auth-form-container text-start">
							<form class="auth-form login-form" action="handlelogin.php" method="post">
								<?php
								if (isset($_GET['error'])) {
							...
							<div class="auth-option text-center pt-5">Add an employee <a class="text-link" href="Addemployee.php">here</a>.</div>
						</div>
						<!--//auth-form-container-->
