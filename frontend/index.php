                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item"><a class="submenu-link" href="settings.php">Settings</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure">
                                    <?php
                                    include('connection.php');
                                    $sql = "SELECT COUNT(amount) AS cont FROM transaction WHERE amount IS NOT NULL";
                                    $res = mysqli_query($conn, $sql);
                        ...
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure"> <?php
                                                            include('connection.php');
                                                            // $sql = "SELECT sum() AS cont FROM transaction";
                                                            // $res = mysqli_query($conn, $sql);
                                                            // $row = mysqli_fetch_assoc($res);
                                                            // echo $row['cont'];
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure"><?php
                                                            $sql = "SELECT
								r.id AS realstate_id,
								COALESCE(SUM(t.amount), 0) AS total_transaction_amount,
								r.price - COALESCE(SUM(t.amount), 0) AS remaining_balance
							FROM
								realstate r
							LEFT JOIN
								transaction t ON r.id = t.realstateId
							GROUP BY
								r.id, r.price;
							";
