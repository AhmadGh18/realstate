...
if ($res) {
	...
	if (!empty($profilePicURL)) {
		...
		// Display a default image or any other content when there is no profile picture
		echo '<img class="default-image profile-image" src="assets/Default_pfp (1).jpg" alt="Default Image">';
	}
} else {
	echo "Error fetching user information: " . mysqli_error($conn);
}
...
?>
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
											...
											if ($res) {
												...
												echo '<div class="item-data">' . $fullName . '</div>';
											}
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
											...
											if ($res) {
												...
												echo '<div class="item-data">' . $email . '</div>';
											} else {
												echo "Error fetching user information: " . mysqli_error($conn);
											}
                            ...
                            <div class="app-card-footer p-4 mt-auto">
                                <a class="btn app-btn-secondary" href="manageprofile.php">Manage Profile</a>
                            </div>
                            <!--//app-card-footer-->
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <div class="item-label"><i
                                                    class="fab fa-cc-visa me-2"></i><strong>Credit/Debit Card
                                                </strong>
                                            </div>
                            ...
                            <!--//app-card-body-->
                            <div class="app-card-footer p-4 mt-auto">
                                <a class="btn app-btn-secondary" href="Payment.php">Manage Payment</a>
                            </div>
                            <!--//app-card-footer-->
