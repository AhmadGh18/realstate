                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
                                <li><span class="text-muted">Type:</span> <?php echo $title ?></li>
                                <li><span class="text-muted">Size:</span> <?php echo $price  ?></li>
                                <li><span class="text-muted">Uploaded:</span> <?php echo $location ?></li>
                            </ul>
                        </div>
                        <!--//app-doc-meta-->
                        ...
                        <div class="app-card-actions">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="viewreal.php?id=<?php echo $row['id'] ?>"><svg
                                                width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye me-2"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                    ...
                                    <li><a class="dropdown-item" href="editreal.php?id=<?php echo $row['id'] ?>" ]"><svg
                                                width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil me-2"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
