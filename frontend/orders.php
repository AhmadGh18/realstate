                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item"><a class="submenu-link" href="account.php">Account</a>
                                    </li>
                                ...
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT transaction.*, users.first_name, realstate.title
        FROM transaction
        JOIN users ON transaction.clientid = users.id
        JOIN realstate ON transaction.realstateid = realstate.id";
                                            ...
                                            while ($row = mysqli_fetch_assoc($res)) {
                                                ...
                                                echo '<td class="cell"><span>' . date("d M Y", strtotime($row["date_of_transaction"])) . '</span></td>';
                                                echo '<td class="cell"><span>' . date($row["amount"]) . '</span></td>';
