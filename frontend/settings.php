                            ...
                            <div class="app-card-body">
                                <form class="settings-form" action="companyinfo.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="setting-input-2"
                                            value="<?php echo $data['phone_Number'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="setting-input-3" class="form-label">Business Email Address</label>
                                        <input name="email" type="email" class="form-control" id="setting-input-3"
                                            value="<?php echo $data['Email'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="setting-input-3" class="form-label">Description</label>
                                        <input name="bio" type="text" class="form-control" id="setting-input-3"
