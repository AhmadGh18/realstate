        ...
        <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <h2 class="auth-heading text-center mb-5">Creat an account</h2>
                    <div class="auth-form-container text-start">
                        <form class="auth-form login-form" action="handlelcreateacc.php" method="post">
                            <?php
                            if (isset($_GET['error'])) {
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="firstname" name="firstname" type="text" class="form-control" placeholder="First Name" required="required">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="sr-only" for="lastname">Last Name</label>
                                        <input id="lastname" name="lastname" type="text" class="form-control" placeholder="Last Name" required="required">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="signin-email" name="username" type="text" class="form-control signin-email" placeholder="User_exampleName" required="required">
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="sr-only" for="signin-password">Repeat Password</label>
                                <input id="signin-password" name="password_confirmation" type="password" class="form-control signin-password" placeholder="Repeat Password" required="required">
                            </div>
                        ...
                        <div class="auth-option text-center pt-5">Already have an email ? <a class="text-link" href="login.php">here</a>.</div>
                    </div>
                    <!--//auth-form-container-->
